...
export const faqs: FAQ[] = [
  {
    id: 'what-is-shivasankalpa',
    question: 'What is Sri Shivasankalpa Trust?',
    answer:
  ...
  {
    id: 'what-does-shivasankalpa-mean',
    question: 'What does "Shivasankalpa" mean?',
    answer:
  ...
  },
  {
    ...
    answer:
      'We are in the process of obtaining 80G certification. Once approved, donations will be eligible for tax benefits under Section 80G of the Income Tax Act. We will update this page when the certification is in place. #FAQ-TODO-80g-status',
  },
  {
    id: 'which-gurukulas',
  ...
  {
    id: 'sringeri-connection',
    question: 'What is the trust\'s connection to Sringeri?',
    answer:
